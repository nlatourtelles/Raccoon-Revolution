...
//theUpgrades an array of variables that will buff/nerf the player
//0 = new bullet, 1 = bulletUp, 2 = bulletDown, 3 = BulletLeft, 4 = BulletRight, 5 = health, 6 = fire rate, 7 = movement speed, 8 = scale;
function PowerUp(game, powerUpSprite , theX, theY, change, bUp, bDown, bLeft, bRight, health, frate, move, scale) { 
    this.x = theX;
    this.y = theY;
    this.game = game;
    this.ctx = game.ctx;
    ...
    this.changeBullet = change;
    
    this.BulletUp = "./img/Bullet_Down.png";
...
PowerUp.prototype.update = function() {
    if(this.hitBox.x < this.game.player.hitBox.x + this.game.player.hitBox.width &&
        ...
        this.hitBox.height + this.hitBox.y > this.game.player.hitBox.y) {
            console.log(this.changeBullet);
            if(this.changeBullet = 1) {
                console.log(this.game.player.bulletUp.sprite);
                ...
                console.log("THIS WORK THIS WORKED");
            }
            ...
            //^this should remove the powerup but for some reason does not.
            this.state = false;
            //these will probably need to be removed if a better way of removing the power up is found
            this.hitBox.x = -3;
            this.hitBox.y = -3;
            this.hitBox.width = 0;
...
AM.downloadAll(function () {
    ...
    gameEngine.addEntity(new PowerUp(gameEngine, AM.getAsset("./img/pebble.png"), 200, 200), 1,  "./img/Bullet_Down.png", "./img/Bullet_Down.png", "./img/Bullet_Down.png",  "./img/Bullet_Down.png",  2,  1, 20, 1);
